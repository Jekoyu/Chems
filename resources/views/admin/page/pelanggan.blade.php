        ...
        <div class="modal-content">
            ...
            <form id="addProductForm" action="{{ route('storeProduct') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="deskripsi" class="form-label">HP</label>
                        <input type="number" class="form-control" id="deskripsi" name="deskripsi" rows="3" required></input>
                    </div>
        ...
        $('#addProductForm').submit(function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    $('#addModal').modal('hide');
                    // Tambahkan kode di sini untuk menanggapi respons dari server
