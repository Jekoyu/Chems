                    ...
                    <ul class="nav navbar-nav menu_nav ml-auto">
                        ...
                        <li class="nav-item submenu dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li class="nav-item"><a class="nav-link" href="{{route('category')}}">Kategori Produk</a></li>
                                <li class="nav-item"><a class="nav-link" href="{{route('single-product')}}">Detail Produk</a></li>
                                ...
                                <li class="nav-item"><a class="nav-link" href="{{route('confirmation')}}">Konfirmasi Produk</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item submenu dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="nav-item"><a class="nav-link" href="{{route('tracking')}}">Lacak Pesanan</a></li>
                            </ul>
                        </li>
